...
async def call_openai_bot(botname: str, payload: OpenAIRequest):
    """
    Endpoint to interact with OpenAI's ChatCompletion API using a JSON body.

    Args:
        botname (str): The model name to use (e.g., 'gpt-3.5-turbo').
        payload (OpenAIRequest): The request payload containing 'request' and 'apikey'.
    ...
    try:
        ...
        partial_gen = openai_partial_messages(apikey, botname, user_request)
